...
class CapNhatNhaXuatBanRequest extends FormRequest
{
    ...
    {
        return [
            'ten_nha_xuat_ban'           => 'required|max:100|unique:nha_xuat_ban,ten_nha_xuat_ban,'.$this->id,
            'dia_chi_nha_xuat_ban'       => 'required|max:100|unique:nha_xuat_ban,dia_chi_nha_xuat_ban,'.$this->id,
            'website_nha_xuat_ban'       => 'required|max:100|url|unique:nha_xuat_ban,website_nha_xuat_ban,'.$this->id,
            'email_nha_xuat_ban'         => 'required|max:100|email|unique:nha_xuat_ban,email_nha_xuat_ban,'.$this->id,

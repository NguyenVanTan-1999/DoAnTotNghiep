...
namespace App\Http\Requests\Admin\HinhThucSanPham;
...
class ThemMoiHinhThucSanPhamRequest extends FormRequest
{
    ...
    {
        return [
            'loai_hinh_thuc_san_pham'  => 'required|min:7|max:10|unique:hinh_thuc_san_pham,loai_hinh_thuc_san_pham',
    ...
    public function messages()
    {
        return [
            ...
            'loai_hinh_thuc_san_pham.min'        => 'Loại Hình Thức Sản Phẩm Phải Ít Nhất 7 Ký Tự',

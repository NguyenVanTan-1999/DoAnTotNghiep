			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
				<div class="shop-left">
					...
					<div class="left-menu mb-30">
						<ul>
							<li><a href="{{ route('website-ban-sach.tim-kiem-pt1') }}">20.000 - 50.000</a></li>
							<li><a href="{{ route('website-ban-sach.tim-kiem-pt2') }}">50.000 - 100.000</a></li>
							<li><a href="{{ route('website-ban-sach.tim-kiem-pt3') }}">100.000 - 200.000</a></li>
							<li><a href="{{ route('website-ban-sach.tim-kiem-pt4') }}">200.000 - 500.000</a></li>
							<li><a href="{{ route('website-ban-sach.tim-kiem-pt5') }}">500.000 - 1.000.000</a></li>
						</ul>
					</div>
	                                ...
	                                <div class="product-wrapper mb-40">
	                                    <div class="product-img">
	                                        ...
	                                        <div class="product-flag">
	                                            <ul>
	                                                ...
	                                                <li><span class="discount-percentage">-{{ (($sanphamgrid->gia_tien_san_pham - $sanphamgrid->gia_tien_giam_gia) * 100 / ($sanphamgrid->gia_tien_san_pham)) }}%</span></li>
	                                            </ul>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="product-link">
	                                        <div class="product-button">
	                                            <a href="{{ route('website-ban-sach.them-vao-gio', $sanphamgrid->id) }}" title="Thêm Vào Giỏ"><i class="fa fa-shopping-cart"></i>Thêm Vào Giỏ</a>
	                                        </div>
								...
								<div class="row">
									...
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
										<div class="product-wrapper-content">
											...
											<div class="product-link">
												<div class="product-button">
													<a href="{{ route('website-ban-sach.them-vao-gio', $sanphamlist->id) }}" title="Thêm Vào Giỏ"><i class="fa fa-shopping-cart"></i>Thêm Vào Giỏ</a>
												</div>
												<div class="add-to-link">
	                                                <ul>

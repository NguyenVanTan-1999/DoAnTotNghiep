		...
		<div class="row">
			...
			<div class="post-active owl-carousel text-center">
				...
				<div class="col-lg-12">
					<div class="single-post">
						<div class="post-img">
							<a href="#"><img src="{{ asset('assets/Web/img/post/2.jpg') }}" alt="post" /></a>
							<div class="blog-date-time">
							    <span class="day-time">06</span>
                                <span class="moth-time">Dec</span>
							</div>
						...
						<div class="post-content">
							<h3><a href="#">Interdum et malesuada</a></h3>
							<span class="meta-author"> Demo Posthemes </span>
							<p>Discover five of our favourite dresses from our new collection that are destined to be worn and loved immediately.</p>
						</div>
					</div>
				...
				<div class="col-lg-12">
					<div class="single-post">
						<div class="post-img">
							<a href="#"><img src="{{ asset('assets/Web/img/post/3.jpg') }}" alt="post" /></a>
							<div class="blog-date-time">
				...
				<div class="col-lg-12">
					<div class="single-post">
						<div class="post-img">
							<a href="#"><img src="{{ asset('assets/Web/img/post/4.jpg') }}" alt="post" /></a>
							<div class="blog-date-time">

...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2><span style="font-size: 35px;">Danh Sách Hóa Đơn</span></h2>
      ...
      <div class="x_content">
        ...
        <a href="{{ route('hoa-don.thung-rac') }}"><button type="button" class="btn btn-round btn-primary">Khôi Phục</button></a><br /><br />
          ...
          <tbody>
          	...
          	@foreach($dsHoaDon as $hoadon)
                ...
                <td>{{ $hoadon->tong_tien }}</td>
                  ...
                  <a href="{{ route('hoa-don.xu-ly-cap-nhat', $hoadon->id) }}"><button type="button" class="btn btn-round btn-success">Xác Nhận</button></a>

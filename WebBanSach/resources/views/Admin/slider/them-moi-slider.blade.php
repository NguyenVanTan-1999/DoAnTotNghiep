...
<div class="row">
  <div class="col-md-12 col-sm-12">
    <div class="x_panel">
      <div class="x_title">
        <h2><span style="font-size: 35px;">Thêm Mới Slider</span></h2>
      ...
      <div class="x_content">
        ...
        <form action="{{ route('slider.xu-ly-them-moi') }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="hinh_anh_slider">Hình Ảnh Slider <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6">
              <input type="file" id="hinh_anh_slider" name="hinh_anh_slider" title="hình ảnh slider với tên không vượt quá 255 ký tự, bao gồm đuôi mở rộng là jpeg, png, jpg" required>
            </div>
          </div>

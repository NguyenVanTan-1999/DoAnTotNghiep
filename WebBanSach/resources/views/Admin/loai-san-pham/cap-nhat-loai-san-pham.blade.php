      ...
      <div class="x_content">
        ...
        <form action="{{ route('loai-san-pham.xu-ly-cap-nhat', $loaisanPhams->id) }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="text" id="ten_loai_san_pham" name="ten_loai_san_pham" class="form-control" title="tên loại sản phẩm không vượt quá 40 ký tự" maxlength="40" value="{{ $loaisanPhams->ten_loai_san_pham }}">
            </div>
          </div>

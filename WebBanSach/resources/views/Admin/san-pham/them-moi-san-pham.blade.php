        ...
        <form action="{{ route('san-pham.xu-ly-them-moi') }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="text" id="ma_san_pham" name="ma_san_pham" class="form-control" placeholder="VD: SP000" title="mã sản phẩm dài 5-10 ký tự, bao gồm chữ hoa và số" minlength="5" maxlength="10" pattern="^[A-Z]{2}[0-9]{3,}$" required>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="text" id="ten_san_pham" name="ten_san_pham" class="form-control" title="tên sản phẩm không vượt quá 60 ký tự" maxlength="60" required>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <textarea type="text" id="thong_tin_san_pham" name="thong_tin_san_pham" class="form-control" title="thông tin sản phẩm không vượt quá 1000 ký tự" maxlength="1000" required></textarea>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="date" id="ngay_xuat_ban_san_pham" name="ngay_xuat_ban_san_pham" required>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="number" id="gia_tien_san_pham" name="gia_tien_san_pham" class="form-control" title="giá tiền sản phẩm nằm trong khoảng 1.000 vnđ đến 999.999 vnđ" min="1000" max="999999" required>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="number" id="gia_tien_giam_gia" name="gia_tien_giam_gia" class="form-control" title="giá tiền giảm giá phải nhỏ hơn giá tiền sản phẩm, nằm trong khoảng 0 vnđ đến 999.999 vnđ" min="0" max="999999" required>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="number" id="phan_tram_giam_gia" name="phan_tram_giam_gia" class="form-control" title="phần trăm giảm giá nằm trong khoảng 0 % đến 100 %" min="0" max="100" required>
            </div>
          </div>

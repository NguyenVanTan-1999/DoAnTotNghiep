...
<div class="row">
  <div class="col-md-12 col-sm-12">
    <div class="x_panel">
      <div class="x_title">
        <h2><span style="font-size: 35px;">Thêm Mới Hình Thức Sản Phẩm</span></h2>
      ...
      <div class="x_content">
        ...
        <form action="{{ route('hinh-thuc-san-pham.xu-ly-them-moi') }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="text" id="loai_hinh_thuc_san_pham" name="loai_hinh_thuc_san_pham" class="form-control" placeholder="VD: HTSP000" title="loại hình thức sản phẩm dài 7-10 ký tự, bao gồm chữ hoa và số" minlength="7" maxlength="10" pattern="^[A-Z]{4}[0-9]{3,}$" required>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="text" id="ten_hinh_thuc_san_pham" name="ten_hinh_thuc_san_pham" class="form-control" title="tên hình thức sản phẩm không vượt quá 40 ký tự" maxlength="40" required>
            </div>
          </div>

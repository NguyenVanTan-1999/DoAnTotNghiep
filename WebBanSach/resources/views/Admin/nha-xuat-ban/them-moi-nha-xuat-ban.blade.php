        ...
        <form action="{{ route('nha-xuat-ban.xu-ly-them-moi') }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="text" id="ma_nha_xuat_ban" name="ma_nha_xuat_ban" class="form-control" maxlength="10">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="text" id="ten_nha_xuat_ban" name="ten_nha_xuat_ban" class="form-control" maxlength="100">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="text" id="dia_chi_nha_xuat_ban" name="dia_chi_nha_xuat_ban" class="form-control" maxlength="100">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="url" id="website_nha_xuat_ban" name="website_nha_xuat_ban" class="form-control" maxlength="100">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="email" id="email_nha_xuat_ban" name="email_nha_xuat_ban" class="form-control" maxlength="100">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="tel" id="so_dien_thoai_nha_xuat_ban" name="so_dien_thoai_nha_xuat_ban" class="form-control" pattern="[0-9]{8,11}">
            </div>
          </div>
